...
import jp.issei.omizu.weightcalendar.presentation.internal.di.modules.GoogleApiModule;
 ...
 */
@PerActivity
@Component(dependencies = ApplicationComponent.class, modules = {ActivityModule.class, GoogleApiModule.class, PreferenceModule.class})
