 ...
 */
public class GetPhysicalMeasurementDetails extends UseCase<PhysicalMeasurement, GetPhysicalMeasurementDetails.Params> {

  private final PhysicalMeasurementRepository physicalMeasurementRepository;

  @Inject
  GetPhysicalMeasurementDetails(PhysicalMeasurementRepository physicalMeasurementRepository, ThreadExecutor threadExecutor,
