 ...
 */
public class ExportPhysicalMeasurement extends UseCase<List<PhysicalMeasurement>, ExportPhysicalMeasurement.Params> {

  private final PhysicalMeasurementRepository physicalMeasurementRepository;

  @Inject
  ExportPhysicalMeasurement(PhysicalMeasurementRepository physicalMeasurementRepository, ThreadExecutor threadExecutor,
  ...
  Observable<List<PhysicalMeasurement>> buildUseCaseObservable(Params params) {
    return this.physicalMeasurementRepository.exportPhysicalMeasurements(params.credential);
  }
