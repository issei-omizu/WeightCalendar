 ...
 */
public class GetAccountName extends UseCase<String, Void> {

  private final PreferenceRepository preferenceRepository;

  @Inject
  GetAccountName(PreferenceRepository preferenceRepository, ThreadExecutor threadExecutor,
  ...
  Observable<String> buildUseCaseObservable(Void unused) {
    return this.preferenceRepository.getAccountName();
  }
}
